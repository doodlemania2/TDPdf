...
- **Form-aware OCR** (#242) and **Unicode form-font subset reuse** (#256) — both read or write through their engine's form and font services. Ports would mean building the equivalent against our own hand-parsed AcroForm path, which is a change with its own design rather than a sync.
